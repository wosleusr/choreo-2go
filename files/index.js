...
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.luxxk.us.kg';     
const NEZHA_PORT = process.env.NEZHA_PORT || '88';                     // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'YyJZ1sGH8x4gxEvNbqRjjyoRny8IuZSD';   // 没用哪吒，把这个参数空着
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo.wosken.us.kg';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
